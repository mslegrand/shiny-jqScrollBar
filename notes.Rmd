...
Thus we
- put svgR code in a seperate file:  *jqScrollBar_svg.R*
- create a wrapper to source the svg
- call that wrapper from the constructor for *jqScrollBar*
...
- Starts in the server by calling the function *updateJqScrollBar*
...
- svg sends a message to the **jqScrollBar**, probably **clicked**
